...
```
root@xec412:~$ cat tech_stack.txt
```

`// LANGUAGES`

![C](https://img.shields.io/badge/C-1A0808?style=flat-square&logo=c&logoColor=D4A017)
![x64 MASM](https://img.shields.io/badge/x64_MASM-0C0606?style=flat-square&logoColor=C0392B)
![Go](https://img.shields.io/badge/Go-060810?style=flat-square&logo=go&logoColor=29B6D8)

`// CURRENTLY LEARNING`

![Rust](https://img.shields.io/badge/Rust_%5BACTIVE%5D-120F03?style=flat-square&logo=rust&logoColor=ECC060)
